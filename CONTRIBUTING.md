# Contributing to Trumpow Core

Trumpow Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/trumpowppc/trumpow/labels/help%20wanted)
* [Projects](https://github.com/trumpowppc/trumpow/projects)
* [Trumpowdev on reddit](https://www.reddit.com/r/trumpowdev/)

## Branch Strategy

Trumpow Core's default branch is intentionally a stable release, so that anyone
...
1.2.0.0 branch is named `1.2.0.0-dev`. When raising PRs, please raise against the
...
Trumpow Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Trumpow Core
releases will automatically benefit from these.

When refactoring Trumpow-specific code, please keep refactoring requests short,
...
The following applies to code changes to Trumpow Core, and is not to be
confused with overall Trumpow Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Trumpow Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Trumpow; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Trumpow
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Trumpow consensus, it must have been
