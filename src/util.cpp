...
const char * const BITCOIN_CONF_FILENAME = "trumpow.conf";
const char * const BITCOIN_PID_FILENAME = "trumpowd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Trumpow";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Trumpow";
#else
    // Unix
    return pathRet / ".trumpow";
#endif
#endif
}
