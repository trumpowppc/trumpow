...
void TestPackageSelection(const CChainParams& chainparams, CScript scriptPubKey, std::vector<CTransactionRef>& txFirst)
{
    ...
    // This tx has a low fee: 1000 trumpowtoshi
...
BOOST_AUTO_TEST_CASE(CreateNewBlock_validity)
{
    ...
    // changed this to trumpow genesis pubkey script
    ...
    // Trumpow: Package selection doesn't work that way because our fees are fundamentally
