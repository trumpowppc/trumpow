...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total trumpow balance of the wallet\n"
...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"TsaCGTi7WgYtg6kEeNb9fayaycJVC7i9UL\"")
            + HelpExampleRpc("validateaddress", "\"TsaCGTi7WgYtg6kEeNb9fayaycJVC7i9UL\"")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are trumpow addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) trumpow address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"TYYrKuRMkcSRovzPngiKLJ3UYFa8erQ5Ku\\\",\\\"Th28hNGW8zc87ae38NfwCb2kYs8etcoQ5R\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"TYYrKuRMkcSRovzPngiKLJ3UYFa8erQ5Ku\\\",\\\"Th28hNGW8zc87ae38NfwCb2kYs8etcoQ5R\\\"]\"")
        ;
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The trumpow address to use for the signature.\n"
            ...
            + HelpExampleCli("signmessage", "\"ThmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"ThmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"ThmtFeTAFUzmRi9bhJhRc6mNsqt2pjCYUD\", \"signature\", \"my message\"")
        );
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw runtime_error(
            ...
            "trumpow-cli and the GUI. There is no server-side difference."
        );
