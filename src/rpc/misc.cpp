...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"balance\"  (string) The current balance in TRMP\n"
            "  \"received\"  (string) The total number of TRMP received (including change)\n"
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"TYZjNxNHuX3k2ttNvDC7foZ4dDEnWVQxk6\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"TYZjNxNHuX3k2ttNvDC7foZ4dDEnWVQxk6\"]}")
        );
    ...
    // Convert from trumpowtoshi to TRMP (divide by 100,000,000)
    const CAmount COIN = 100000000;
    
    // Use ValueFromAmount which properly formats the amount as TRMP
    UniValue result(UniValue::VOBJ);
