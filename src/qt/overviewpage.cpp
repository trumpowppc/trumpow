...
void OverviewPage::UpdateTip()
{
    QStringList tips = {
        ...
        tr("To see ongoing development and contribute, check out the Trumpow Core repository on GitHub"),
        tr("Services that claim to double your trumpows are always ponzi schemes")
    };
