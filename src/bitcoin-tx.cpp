...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s trumpow-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  trumpow-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded trumpow transaction") + "\n" +
              "  trumpow-tx [options] -create [commands]   " + _("Create hex-encoded trumpow transaction") + "\n" +
              "\n";
