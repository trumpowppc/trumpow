...
bool AppInitParameterInteraction()
{
    ...
    // 1-trumpowtoshi-fee transactions. It should be set above the real
    ...
    // This is the maximum absolute fee (in COIN, not trumpowtoshis)
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // Trumpow: Do we need to do any RPC mining init here?
