 ...
 *
 *  Trumpow:    Increment mempool limits and accept RBF in steps of 0.0001 TRMP
...
/**
 * Trumpow: Default dust limit that is evaluated when considering whether a
...
/**
 * Trumpow: Default hard dust limit that is evaluated when considering whether
