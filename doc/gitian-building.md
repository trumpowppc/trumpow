...
./gitian-build.sh --docker --setup 1.2.2.0

#Build & sign executables
./gitian-build.sh --docker --build --sign SIGNER 1.2.2.0

#Verify signatures
./gitian-build.sh --verify 1.2.2.0
```

Or to do everything at once :
```bash
./gitian-build.sh --docker --setup --build --sign SIGNER --verify 1.2.2.0
```
