...
Development
---------------------
The Trumpow repo's [root README](/README.md) contains relevant information on the development process and automated testing.
...
This product includes software developed by the Bitcoin developers for use in [Trumpow Core](https://www.bitcoin.org/). 
